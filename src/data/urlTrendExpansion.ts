...
const briefs: TrendBrief[] = [
  ...
  { slug: 'steamdb-player-count', group: 'news', template: 'faq', title: "Mistfall Hunter SteamDB & Player Count", h1: "Mistfall Hunter SteamDB & Player Count", trend: 'mistfall hunter steamdb', growth: 'steam charts adjacent', intent: 'players looking for SteamDB-style concurrent player data', answer: 'Steam concurrent players peaked at roughly 44,375 within the first week, per Steam tracking data — but that figure is Steam-only and misses Xbox, Xbox Game Pass, and PS5 players entirely. Bellring separately announced the game passed 500,000 total players on August 1. Treat any single number you see as a partial, Steam-only signal, not the game\'s total population.', update: 'Add live Steam app data after launch when public tracking is stable.' },
  { slug: 'concurrent-players-tracker', group: 'news', template: 'faq', title: "Mistfall Hunter Concurrent Players Tracker", h1: "Mistfall Hunter Concurrent Players Tracker", trend: 'mistfall hunter concurrent players', growth: 'steam charts adjacent', intent: 'players searching peak players and launch population', answer: 'Steam concurrent players peaked at roughly 44,375 within the first week, per Steam tracking data, and Bellring announced the game passed 500,000 total players on August 1. The concurrent figure is Steam-only — Xbox, Game Pass, and PS5 players are not counted in Steam\'s charts, so the real cross-platform population is higher.', update: 'Add launch-day peaks, first weekend peaks, and post-patch changes after release.' },
  { slug: 'player-count-launch-week', group: 'news', template: 'faq', title: "Mistfall Hunter Launch Week Player Count", h1: "Mistfall Hunter Launch Week Player Count", trend: 'mistfall hunter player count launch week', growth: 'steam charts adjacent', intent: 'players tracking first-week popularity', answer: 'Steam concurrent players peaked at roughly 44,375 within the first week, and Mistfall Hunter reached the #1 spot on Twitch, alongside Bellring\'s announcement of 500,000 total players on August 1. Launch-week numbers are also affected by queues and how many players are on Xbox, PS5, or Game Pass instead of Steam — a lower Steam number during off-peak hours doesn\'t necessarily mean low overall interest.', update: 'Refresh daily during launch week with public numbers and notes.' },
  ...
  // release-date-july-30 was removed here 2026-07-24: its intent (exact
  // July launch date, time-zone conversion, platform access, last-week
  // checklist) fully overlaps with /release-date, /release-time-time-zones,
  // and /launch-day-checklist, which were promoted the same day. Rather
  // than rename a slug with a wrong date baked into it just to keep a
  // now-redundant page alive, the URL 301-redirects to /release-date
  ...
  { slug: 'steam-reviews-tracker', group: 'news', template: 'faq', title: "Mistfall Hunter Steam Reviews Tracker", h1: "Mistfall Hunter Steam reviews tracker", trend: 'mistfall hunter steam reviews', growth: 'steam adjacent', intent: 'players checking early reception', answer: 'Mistfall Hunter\'s Steam reviews sit at Mixed as of this writing, with roughly 68% positive out of over 1,700 reviews. Common complaints are stuttering and desync at launch, no dedicated Oceania servers, and no dedicated Duo (two-player) matchmaking; common praise cites the Souls-like combat feel and PvP tension.', update: 'Add review score, common praise, and common issues after launch.' },
  ...
  { slug: 'crossplay-status', group: 'news', template: 'faq', trend: 'mistfall hunter crossplay', growth: '+7%', intent: 'players checking whether PC, Xbox, and PS5 can play together', answer: 'Yes \u2014 full cross-play across PC, PS5, and Xbox Series X|S is confirmed and live. Squadmates on different platforms can play together now that servers are open. Note that cross-platform play is separate from cross-region play: some players have reported being unable to party with friends in a different region after launch, which has not been officially addressed by Bellring as of this writing.', update: 'Confirm exact cross-progression (shared account/unlocks) rules and the region-restriction reports once official, separate from cross-play itself.', title: 'Is Mistfall Hunter Crossplay? Yes \u2014 PC, Xbox & PS5', h1: 'Is Mistfall Hunter Crossplay?' },
  { slug: 'cross-platform-party-guide', group: 'news', template: 'faq', title: "Mistfall Hunter Cross-Platform Party Guide", h1: "Mistfall Hunter cross-platform party guide", trend: 'mistfall hunter cross platform party', growth: 'crossplay adjacent', intent: 'friends planning mixed-platform squads', answer: 'Full cross-play across PC, Xbox, and PS5 is confirmed and live — players on different platforms can party up and hunt together now. Cross-progression (shared account/unlocks across platforms) is a separate feature and has not been confirmed the same way.', update: 'Add official party and account-linking details when verified.' },
  ...
  { slug: 'pc-xbox-crossplay-guide', group: 'news', template: 'faq', title: "Mistfall Hunter PC & Xbox Crossplay Guide", h1: "Mistfall Hunter PC and Xbox crossplay", trend: 'mistfall hunter pc xbox crossplay', growth: 'crossplay adjacent', intent: 'PC and Xbox players checking party compatibility', answer: 'Yes — PC and Xbox players can party together, since full cross-play across PC, Xbox, and PS5 is confirmed and live. Console online multiplayer on Xbox needs Game Pass Core or Ultimate.', update: 'Verify with official platform support after launch.' },
  { slug: 'ps5-crossplay-guide', group: 'news', template: 'faq', title: "Mistfall Hunter PS5 Crossplay Guide", h1: "Mistfall Hunter PS5 crossplay guide", trend: 'mistfall hunter ps5 crossplay', growth: 'crossplay adjacent', intent: 'PS5 players checking mixed-platform play', answer: 'Yes \u2014 PS5 is included in the confirmed full cross-play across PC, Xbox, and PS5 at launch, so PS5 players can party with PC and Xbox hunters.', update: 'Add PlayStation store and official support wording when available.' },
