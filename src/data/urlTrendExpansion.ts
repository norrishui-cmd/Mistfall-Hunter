...
const briefs: TrendBrief[] = [
  ...
  { slug: 'crossplay-status', group: 'news', template: 'faq', trend: 'mistfall hunter crossplay', growth: '+7%', intent: 'players checking whether PC, Xbox, and PS5 can play together', answer: 'Yes \u2014 full cross-play across PC, PS5, and Xbox Series X|S is confirmed. Squadmates on different platforms can play together once servers open.', update: 'Confirm exact cross-progression (shared account/unlocks) rules once official, separate from cross-play itself.', title: 'Is Mistfall Hunter Crossplay? Yes \u2014 PC, Xbox & PS5', h1: 'Is Mistfall Hunter Crossplay?' },
  { slug: 'cross-platform-party-guide', group: 'news', template: 'faq', title: "Mistfall Hunter Cross-Platform Party Guide", h1: "Mistfall Hunter cross-platform party guide", trend: 'mistfall hunter cross platform party', growth: 'crossplay adjacent', intent: 'friends planning mixed-platform squads', answer: 'Full cross-play across PC, Xbox, and PS5 is confirmed — players on different platforms can party up and hunt together once servers open. Cross-progression (shared account/unlocks across platforms) is a separate feature and has not been confirmed the same way.', update: 'Add official party and account-linking details when verified.' },
  ...
  { slug: 'pc-xbox-crossplay-guide', group: 'news', template: 'faq', title: "Mistfall Hunter PC & Xbox Crossplay Guide", h1: "Mistfall Hunter PC and Xbox crossplay", trend: 'mistfall hunter pc xbox crossplay', growth: 'crossplay adjacent', intent: 'PC and Xbox players checking party compatibility', answer: 'Yes — PC and Xbox players can party together, since full cross-play across PC, Xbox, and PS5 is confirmed for launch. Console online multiplayer on Xbox needs Game Pass Core or Ultimate.', update: 'Verify with official platform support after launch.' },
