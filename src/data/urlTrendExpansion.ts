...
const briefs: TrendBrief[] = [
  ...
  { slug: 'steamdb-player-count', group: 'news', template: 'faq', title: "Mistfall Hunter SteamDB & Player Count", h1: "Mistfall Hunter SteamDB & Player Count", trend: 'mistfall hunter steamdb', growth: 'steam charts adjacent', intent: 'players looking for SteamDB-style concurrent player data', answer: 'Steam concurrent players reached almost 30,000 within the first day (July 30), up from just over 19,000 a few hours after the July 29 launch — but that figure is Steam-only and misses Xbox, Xbox Game Pass, and PS5 players entirely. Treat any single number you see as a partial, Steam-only signal, not the game\'s total population.', update: 'Add live Steam app data after launch when public tracking is stable.' },
  { slug: 'concurrent-players-tracker', group: 'news', template: 'faq', title: "Mistfall Hunter Concurrent Players Tracker", h1: "Mistfall Hunter Concurrent Players Tracker", trend: 'mistfall hunter concurrent players', growth: 'steam charts adjacent', intent: 'players searching peak players and launch population', answer: 'Steam concurrent players reached almost 30,000 within the first day (July 30), up from just over 19,000 a few hours after the July 29 launch, per press tracking. That number is Steam-only — Xbox, Game Pass, and PS5 players are not counted in Steam\'s charts, so the real cross-platform population is higher.', update: 'Add launch-day peaks, first weekend peaks, and post-patch changes after release.' },
  { slug: 'player-count-launch-week', group: 'news', template: 'faq', title: "Mistfall Hunter Launch Week Player Count", h1: "Mistfall Hunter Launch Week Player Count", trend: 'mistfall hunter player count launch week', growth: 'steam charts adjacent', intent: 'players tracking first-week popularity', answer: 'Steam concurrent players reached almost 30,000 within the first day (July 30), up from just over 19,000 within the first few hours of the July 29 launch. Launch-week numbers are also affected by queues and how many players are on Xbox, PS5, or Game Pass instead of Steam — a lower Steam number during off-peak hours doesn\'t necessarily mean low overall interest.', update: 'Refresh daily during launch week with public numbers and notes.' },
