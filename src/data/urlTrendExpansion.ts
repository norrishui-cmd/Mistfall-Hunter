...
const briefs: TrendBrief[] = [
  ...
  { slug: 'crossplay-status', group: 'news', template: 'faq', trend: 'mistfall hunter crossplay', growth: '+7%', intent: 'players checking whether PC, Xbox, and PS5 can play together', answer: 'Yes \u2014 full cross-play across PC, PS5, and Xbox Series X|S is confirmed and live. Squadmates on different platforms can play together now that servers are open.', update: 'Confirm exact cross-progression (shared account/unlocks) rules once official, separate from cross-play itself.', title: 'Is Mistfall Hunter Crossplay? Yes \u2014 PC, Xbox & PS5', h1: 'Is Mistfall Hunter Crossplay?' },
