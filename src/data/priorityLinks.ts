...
const enLinks: PriorityLink[] = [
  ...
  { title: '100-question FAQ', desc: 'Verified answers covering release, platforms, gameplay, multiplayer, and technical issues.', href: '/faq', group: 'guides' },
  ...
  { title: 'Build planner', desc: 'Choose a class, path, goal, and priority affixes, then share the result.', href: '/build-planner', group: 'tools' },
...
const zhLinks: PriorityLink[] = [
  ...
  { title: '100 问完整 FAQ', desc: '覆盖发售、平台、玩法、联机与技术问题的已核实答案。', href: '/zh/faq', group: 'guides' },
  ...
  { title: '配装规划器', desc: '选择职业、流派、目标与优先词缀，并分享规划结果。', href: '/zh/build-planner', group: 'tools' },
