...
const briefs: FaqBrief[] = [
  ...
  { slug: 'faq-is-there-solo-mode', group: 'guides', question: 'Can you play Mistfall Hunter solo?', intent: 'solo mode search', answer: 'Yes. Solo play is a supported way to enter the same PvPvE zones as squads \u2014 you are not required to group up. Solo players should favor shorter routes, quiet looting, safer classes, and earlier extraction than a full squad would.', update: 'Add live solo queue and route evidence after launch.' },
  ...
  { slug: 'faq-can-you-farm-pve-only', group: 'database', question: 'Is there a PvE-only mode in Mistfall Hunter?', intent: 'PvE-only mode search', answer: 'Not yet, but it\u2019s planned: in a GamingBolt interview published July 28, 2026, Bellring Games confirmed a pure PvE mode is on the roadmap, without committing to a release date. At launch, Mistfall Hunter remains a PvPvE extraction game, meaning rival hunters can appear in any zone. Until the PvE-only mode ships, you can lean into PvE-focused routes \u2014 quieter paths, less contested loot, and early extraction \u2014 but full protection from other players is not available.', update: 'Track official Steam news for a release window once Bellring commits to one.' },
