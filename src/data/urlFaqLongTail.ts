...
const briefs: FaqBrief[] = [
  ...
  { slug: 'faq-can-you-farm-pve-only', group: 'database', question: 'Is there a PvE-only mode in Mistfall Hunter?', intent: 'PvE-only mode search', answer: 'No dedicated PvE-only mode has been officially confirmed. Mistfall Hunter is built as a PvPvE extraction game, meaning rival hunters can appear in any zone. You can lean into PvE-focused routes \u2014 quieter paths, less contested loot, and early extraction \u2014 but full protection from other players is not confirmed.', update: 'Confirm whether any PvE-only queue or mode exists once the launch build is live.' },
