...
export const localizedCorePaths = new Set([
  ...
  '/mercenary-beginner-build', '/mercenary-solo-build', '/mercenary-pvp-build', '/mercenary-boss-build', '/mercenary-affix-priority', '/sorcerer-beginner-build', '/sorcerer-solo-build', '/sorcerer-pvp-build', '/sorcerer-boss-build', '/sorcerer-affix-priority', '/blackarrow-solo-build', '/blackarrow-pvp-build', '/blackarrow-boss-build', '/blackarrow-affix-priority', '/blackarrow-controller-settings', '/shadowstrix-pvp-build', '/shadowstrix-boss-build', '/shadowstrix-affix-priority', '/shadowstrix-beginner-build', '/shadowstrix-map-routes', '/seer-beginner-build', '/seer-solo-build', '/seer-pvp-build', '/seer-boss-build', '/seer-affix-priority', '/withered-knight-beginner-build', '/withered-knight-solo-build', '/withered-knight-boss-build', '/withered-knight-affix-priority', '/withered-knight-matchups', '/hallowgrove-solo-route', '/hallowgrove-loot-route', '/hallowgrove-boss-route', '/hallowgrove-chaos-route', '/hallowgrove-extraction-points', '/brandrgarde-solo-route', '/brandrgarde-loot-route', '/brandrgarde-boss-route', '/brandrgarde-chaos-route', '/brandrgarde-extraction-points', '/gyldenmist-timer-guide', '/shrine-extraction-guide', '/bell-creature-guide', '/loot-loss-guide', '/stash-management-guide', '/gear-score-guide', '/perfect-block-guide', '/no-lock-on-combat-guide', '/weapon-swap-guide', '/co-op-team-guide', '/solo-vs-squad-guide', '/third-party-guide', '/sound-cues-guide', '/beginner-loadout-guide', '/best-settings-low-end-pc', '/best-class-for-pvp', '/best-class-for-bosses', '/best-class-for-solo', '/class-counters-guide', '/class-roles-guide', '/gameplay-loop-explained', '/gameplay-trailer-breakdown', '/first-30-minutes-guide', '/combat-gameplay-guide', '/pvp-gameplay-guide', '/pve-gameplay-guide', '/solo-gameplay-guide', '/co-op-gameplay-guide', '/mistfall-hunters-spelling', '/mistfall-hunter-vs-mistfall-hunters', '/mistfall-hunter-name-guide', '/release-time-time-zones', '/launch-day-checklist', '/launch-week-roadmap', '/pre-launch-guide', '/steam-release-time', '/steam-demo-guide', '/steam-reviews-tracker', '/steam-wishlist-guide', '/cross-platform-party-guide', '/cross-progression-guide', '/pc-xbox-crossplay-guide', '/ps5-crossplay-guide', '/steam-price-guide', '/xbox-price-guide', '/ps5-price-guide', '/game-pass-or-buy-guide', '/classes-overview-2026', '/classes-ranked-for-launch', '/classes-for-squads', '/classes-for-beginners-2026', '/best-route-for-beginners', '/safe-loot-route-guide', '/high-risk-high-reward-route', '/duo-route-guide', '/trio-route-guide', '/rat-route-guide', '/boss-rush-route-guide', '/extraction-camping-counter-guide', '/ambush-guide', '/escape-after-kill-guide', '/best-affixes-for-solo', '/best-affixes-for-pvp', '/best-affixes-for-pve', '/best-affixes-for-bosses', '/gear-rarity-guide', '/weapon-tier-list', '/armor-guide', '/consumables-guide', '/crafting-guide', '/vendor-guide', '/returner-woodling-guide', '/soul-of-return-farming', '/gyldenblood-farming-route', '/corroded-enemies-guide', '/mist-lord-guide', '/boss-rewards-guide', '/boss-mechanics-guide', '/pve-enemy-drops-guide', '/rare-loot-guide', '/loot-priority-list', '/mound-omen-of-cthulhu-comparison', '/lovecraftian-dark-fantasy-games', '/cthulhu-fans-mistfall-hunter-guide', '/dark-fantasy-extraction-games-2026', '/horror-fans-guide-to-mistfall-hunter', '/dark-and-darker-vs-mistfall-hunter', '/dungeonborne-vs-mistfall-hunter', '/elden-ring-nightreign-vs-mistfall-hunter', '/escape-from-tarkov-vs-mistfall-hunter', '/hunt-showdown-vs-mistfall-hunter', '/dark-souls-fans-guide', '/extraction-shooter-players-guide', '/soulslike-extraction-guide', '/is-mistfall-hunter-like-dark-souls', '/is-mistfall-hunter-like-dark-and-darker', '/best-graphics-settings', '/best-visibility-settings', '/stutter-fix-guide', '/crash-fix-guide', '/low-fps-fix-guide', '/best-controller-sensitivity', '/best-keyboard-mouse-settings', '/ultrawide-support-guide', '/cloud-gaming-guide', '/family-sharing-guide',
]);
